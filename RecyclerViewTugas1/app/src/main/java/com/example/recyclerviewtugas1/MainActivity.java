...
import com.example.recyclerviewtugas1.Adapter.FoodItemAdapter;
import com.example.recyclerviewtugas1.Models.FoodItem;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rvFoodItem.setLayoutManager(new LinearLayoutManager(this));
    }
}
